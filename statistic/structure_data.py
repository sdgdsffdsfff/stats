...
if __name__ == "__main__":
    ...
    with open('./log_info.data','w') as log_info:
    ...
    db.cursor.execute('LOAD DATA LOCAL INFILE "./log_info.data" INTO TABLE log_info FIELDS TERMINATED BY "," LINES TERMINATED BY "\n"')
    os.remove(log_info.name)
